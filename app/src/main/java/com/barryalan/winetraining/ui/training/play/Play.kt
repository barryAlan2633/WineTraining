...
import com.barryalan.winetraining.ui.shared.customViews.TimerView
...
class Play : BaseFragment() {
    ...
    //study:
    //prices,ingredients in recipe, recipes in menu item, menu items in menu,
...
//        btnAll = requireView().findViewById(R.id.btn_play_all)
    ...
    private fun exitDialog() {
        ...
        btnYes!!.setOnClickListener {
            ...
            alertDialog.dismiss()
            setLives(3)
            requireView().findNavController().navigate(R.id.action_play_to_playMenu)
        }
